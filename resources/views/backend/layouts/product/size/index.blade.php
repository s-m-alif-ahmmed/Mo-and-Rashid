        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom"
                    ...
                    <a href="{{ route('product.size.create') }}" class="btn btn-primary">Add New Size</a>
                </div>
...
@push('scripts')
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('product.size.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('product.size.destroy', ':id') }}';
