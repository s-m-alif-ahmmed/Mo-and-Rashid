    ...
    <div class="all-product--page---wrapper">
        ...
        <div class="common-side--bar">
            ...
            <div class="cart-time-navigation-container">
                <div class="home-time-and-date text-white"><span class="date">10/6/2024</span> <span class="time">1:33 AM
              EDT</span></div>
            ...
            <div class="side-bar-collections-routes">
                @foreach($brands as $brand)
                    <a href="{{ route('brand-product',$brand->brand_slug) }}" class="sidebar-common-route red-background--route">{{ $brand->name }}</a>
                @endforeach
...
{{--                <div class="all-product-page-logo">--}}
{{--                    <a href="{{ route('home') }}">--}}
                            ...
                            @foreach($products as $product)
                                <div class="product-page-product-card" >
                                    ...
                                    <div class="product-images--wrapper">
                                        ...
                                        <a href="{{ route('product.detail', ['category' => $category_slug, 'product_slug' => $product->product_slug]) }}" class="product-details--wrapper">
