        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom"
                    ...
                    <a href="{{ route('product.color.create') }}" class="btn btn-primary">Add New Color</a>
                </div>
...
@push('scripts')
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('product.color.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('product.color.destroy', ':id') }}';
