...
class BackendProductReviewController extends Controller
{
    /**
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('email', function ($data) {
                    return $data->email; // Change user_id to user
                })
                ...
                ->rawColumns(['email', 'name', 'title', 'status', 'action'])
                ->make();
        }
        return view('backend.layouts.product-query.review.index');
    }
    ...
    public function destroy(int $id): JsonResponse {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Failed to delete the Product Review.',
            ]);
        }
    }
}
