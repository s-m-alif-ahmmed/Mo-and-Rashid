...
class SocialController extends Controller
{
    ...
    public function index(Request $request): View | JsonResponse {
        ...
        return view('backend.layouts.settings.social-icon.index');
    }
    ...
    public function create(): View {
        return view('backend.layouts.settings.social-icon.create');
    }
    ...
    public function store(Request $request): RedirectResponse {
        try {
            ...
            return redirect()->route('social.index')->with('t-success', 'Social failed created.');
        }
    }
    ...
    public function edit(int $id): View {
        $data = Social::find($id);
        return view('backend.layouts.settings.social-icon.edit', compact('data'));
    }
    ...
    public function update(Request $request, int $id): RedirectResponse {
        try {
            ...
            return redirect()->route('social.index')->with('t-success', 'Social Updated Successfully.');

        } catch (\Exception) {
            return redirect()->route('social.index')->with('t-success', 'Social failed to update');
        }
    }
    ...
    public function destroy(int $id): JsonResponse {
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Failed to delete the Social.',
            ]);
        }
    }
}
