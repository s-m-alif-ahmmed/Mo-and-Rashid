...
@section('title', 'Products - mo&rashids')
...
{{--                </div>--}}
                ...
                @else
                    <div class="all-products-container--height">
                        <div class="all-products-container" id="product-list">
                            <!-- item 1  -->
                            @foreach($products as $product)
                                <div class="product-page-product-card" >
                                    ...
                                    <div class="product-images--wrapper">
                                        ...
                                        <a href="{{ route('product.detail', $product->product_slug) }}" class="product-details--wrapper">
                                            <!-- image on hover -->
