...
@section('title', 'Payment Failed Orders')

@section('content')
    <div class="page-header">
        <div>
            <h1 class="page-title">Payment Failed Orders</h1>
        </div>
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);">Orders</a></li>
                <li class="breadcrumb-item active" aria-current="page">Payment Failed Orders</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom" style="margin-bottom: 0; display: flex; justify-content: space-between;">
                    <h3 class="card-title">Payment Failed Orders Table</h3>
                </div>
        ...
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#datatable')) {
                let dTable = $('#datatable').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('order.index.payment.failed') }}",
                        type: "GET",
                    },
